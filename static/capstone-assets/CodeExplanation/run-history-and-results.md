...
This document describes the run history UI, server APIs, and result deletion flow added around computation tasks. It also covers run鈥憂ame uniqueness checks in the Computation Panel.
...
Validation logic:
- `runName` is trimmed and compared case鈥慽nsensitively.
