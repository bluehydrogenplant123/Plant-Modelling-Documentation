...
鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
         ...
         鈻?
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
鈹?        AuthProvider (Context)                        鈹?
鈹? - Manages global auth state                          鈹?
鈹? - Stores token, user, userId, userData              鈹?
鈹? - Provides login/logout functions                   鈹?
鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
         鈹?
    鈹屸攢鈹€鈹€鈹€鈹粹攢鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
    鈹?          鈹?             鈹?
    鈻?          鈻?             鈻?
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?  鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
鈹?Login  鈹?鈹?Signup 鈹?  鈹?Protected鈹?
鈹侰omponent鈹?鈹侰omponent鈹?  鈹侰omponents鈹?
鈹斺攢鈹€鈹€鈹€鈹攢鈹€鈹€鈹?鈹斺攢鈹€鈹€鈹攢鈹€鈹€鈹€鈹?  鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
     鈹?        鈹?
     鈹斺攢鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹?
          鈻?
     (Auth State)
     ...
     鈹斺攢 loading
          ...
          鈹?
    鈹屸攢鈹€鈹€鈹€鈹€鈻尖攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
    鈹?  /api/auth/login      鈹?
    鈹?  /api/auth/signup     鈹?
    鈹?  /api/auth/checktoken 鈹?
...
### 5.1 Registration Flow (Signup 鈫?Login)
...
Backend Creates User
  鈹溾攢 Validates email not taken
  鈹溾攢 Hashes password
  鈹溾攢 Creates user record
  鈹斺攢 Returns success
        鈹?
        鈻?
navigate('/login')
...
Backend Authenticates
  鈹溾攢 Find user by email
  鈹溾攢 Verify password hash
  鈹溾攢 Generate JWT/Session token
  鈹斺攢 Return: { accessToken, name }
        鈹?
        鈻?
login(accessToken, name)
        鈹?
        鈹溾攢 localStorage.setItem('authToken', token)
        鈹?
        鈹溾攢 axios.defaults.headers['authorization'] = token
        鈹?
        鈹溾攢 setIsAuthenticated(true)
        鈹?
        鈹斺攢 setUser(name)
        鈹?
        鈻?
...
Backend Validates Token
  鈹溾攢 Decode JWT
  鈹溾攢 Verify signature
  鈹溾攢 Fetch full user data
  鈹斺攢 Return: { name, user: { id, firstName, lastName, email } }
        鈹?
        鈻?
Update State:
  鈹溾攢 setUser(name)
  鈹溾攢 setUserId(userData.id)
  鈹斺攢 setUserData(userData)
        鈹?
        鈻?
Dashboard Component Renders
  鈹斺攢 Access: { user, userId, userData } from context
```
...
const token = localStorage.getItem('authToken')
        鈹?
        鈹溾攢 Token found
        鈹?  鈹溾攢 axios.defaults.headers['authorization'] = token
        鈹?  鈹斺攢 checkAuthToken() 鈫?Verify token valid
        鈹?
        鈹斺攢 No token
            鈹溾攢 setIsAuthenticated(false)
            鈹斺攢 setLoading(false)
```
...
On Route Change
    鈹?
    鈹溾攢 location.pathname changes
    鈹?
    鈹溾攢 if isAuthenticated
    鈹?  鈹斺攢 checkAuthToken()
    鈹?
    鈹斺攢 GET /api/auth/checktoken
        鈹溾攢 Backend validates token
        鈹溾攢 If valid 鈫?Return user data
        鈹溾攢 If expired 鈫?401 error
        鈹?  鈹斺攢 logout() called
        鈹斺攢 User redirected to /login
```
...
**Strategy:** Any error 鈫?logout and require re-login
...
鈹?  LOADING   鈹? (App starts)
鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹?
       鈹?
       鈹溾攢 Token in localStorage?
       鈹?
       鈹溾攢 Yes 鈫?Verify token
       鈹?  鈹溾攢 Valid 鈫?AUTHENTICATED
       鈹?  鈹斺攢 Invalid 鈫?UNAUTHENTICATED
       鈹?
       鈹斺攢 No 鈫?UNAUTHENTICATED
                   鈹?
                   鈻?
         鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
         鈹? UNAUTHENTICATED     鈹?
         鈹? (Show Login/Signup) 鈹?
         鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
                    鈹?
                    鈹溾攢 User clicks Login
                    鈹? 鈹斺攢 Enter credentials
                    鈹?    鈹斺攢 POST /login
                    鈹?       鈹溾攢 Success 鈫?login() 鈫?AUTHENTICATED
                    鈹?       鈹斺攢 Fail 鈫?Show error, stay UNAUTHENTICATED
                    鈹?
                    鈹斺攢 User clicks Signup
                       鈹斺攢 Enter credentials
                          鈹斺攢 POST /signup
                             鈹溾攢 Success 鈫?Navigate to /login
                             鈹斺攢 Fail 鈫?Show error, stay UNAUTHENTICATED
                                 鈹?
                                 鈻?
         鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
         鈹? AUTHENTICATED       鈹?
         ...
         鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
                    ...
                    鈹溾攢 User navigates
                    鈹? 鈹斺攢 checkAuthToken()
                    鈹?    鈹溾攢 Valid 鈫?Stay AUTHENTICATED
                    鈹?    鈹斺攢 Invalid 鈫?logout() 鈫?UNAUTHENTICATED
                    鈹?
                    鈹斺攢 User clicks Logout
                       鈹斺攢 logout() 鈫?UNAUTHENTICATED
```
...
3. Clicks "Sign Up"
4. 鉁?Account created
5. 鉁?Redirected to /login
6. 鉁?Fills email/password
7. 鉁?Clicks "Login"
8. 鉁?Token received and stored
9. 鉁?Redirected to /dashboard
10. 鉁?User data displayed
```

### 14.2 Edge Cases

**Duplicate Email:**
- Signup with existing email 鈫?Error shown
- Should not create duplicate account

**Wrong Password:**
- Login with correct email, wrong password 鈫?Generic error
- Should not reveal if email exists

**Token Expiration:**
- User logged in, token expires
- Navigate to new page 鈫?checkAuthToken fails
- User logged out, redirected to /login

**Lost Connection:**
- Network error during login 鈫?Error shown
...
**Solution:** Check DevTools 鈫?Application 鈫?Storage
...
**Key Flow:**
User 鈫?Login/Signup 鈫?POST /api/auth 鈫?Token received 鈫?localStorage + axios headers 鈫?Dashboard accessible 鈫?checkAuthToken() on each navigation 鈫?logout() to clear state
