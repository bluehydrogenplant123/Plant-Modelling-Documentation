...
- Treat `docs/` as the active current docs source parent.
- Put setup and installation pages under `docs/Installation/`.
- Put current `CodeExplanation` pages under `docs/CodeExplanation/`.
...
- Keep this standards page at `docs/CodeExplanation/CODE_EXPLANATION_GUIDELINES.md`; the published sidebar displays it under `CodeExplanation`.
...
Current source pages under `docs/` use frontmatter. New Docusaurus-rendered current docs should use frontmatter where the target docs surface expects it:
