...
The current Jest configuration is defined in [src/jest.config.js](https://github.com/bluehydrogenplant123/Plant-Modelling-Documentation/blob/main/src/jest.config.js), and the test scripts are available in [src/package.json](https://github.com/bluehydrogenplant123/Plant-Modelling-Documentation/blob/main/src/package.json).
...
This runs the main Jest test command defined in [src/package.json](https://github.com/bluehydrogenplant123/Plant-Modelling-Documentation/blob/main/src/package.json).
