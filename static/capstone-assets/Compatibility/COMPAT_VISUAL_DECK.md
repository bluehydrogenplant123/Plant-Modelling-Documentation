...
- same stable line changes bump **patch** by default, including accepted Excel
  runtime baseline updates
- a new stable branch/release line, such as `6.1.x -> 6.2.x`, bumps **minor**
...
- patch bump for small same-line changes; minor bump only for a new stable line
- one snapshot update
