...
| --- | --- | --- |
| Red | Primary menu and status header | Switch the major working mode from buttons such as **Model**, **Materials**, **Economic**, **Calc Type**, **Analysis**, **Set Run**, **Run**, **Run Result**, **Multi-TP**, **TP Analysis**, **System**, **Display**, and **Help**. This area also includes **Save**, **Refresh Off**, the diagram name, **Back**, and save status. |
