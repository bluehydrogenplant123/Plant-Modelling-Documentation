...
| Orange | Secondary menu | Use actions that belong to the selected primary menu. In this screenshot, **Model** is active, so this row shows actions such as **New Model**, **Open**, **Duplicate Network**, **Extract Selection**, **Subnetwork Editor**, **Import Subnetworks**, **Equation Writing**, **+Constr**, **SoluAlgoLib**, the **Unverified/Verified** state switch, **Base TP**, **Specs**, **Import**, and **Export**. |
