...
The workflow is defined in [.github/workflows/ci.yml](https://github.com/bluehydrogenplant123/Plant-Modelling-Documentation/blob/main/.github/workflows/ci.yml).
...
The workflow uses the project scripts defined in [src/package.json](https://github.com/bluehydrogenplant123/Plant-Modelling-Documentation/blob/main/src/package.json):
