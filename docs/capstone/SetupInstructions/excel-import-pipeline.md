...
```powershell
git diff --check -- docs/SetupInstructions/excel-import-pipeline.md
```
...
- `docs/SetupInstructions/STARTUP_GUIDE.md`
- `docs/SetupInstructions/HYPRONET_INSTALLATION_GUIDE.md`
- `docs/SetupInstructions/backend-data-routes-and-persistence.md`
