...
```powershell
git diff --check -- docs/SetupInstructions/CodeExplanation/time-period-and-economic-flow.md docs/SetupInstructions/CodeExplanation/run-config-and-computation-start.md
```
